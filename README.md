...
| Duplicate-looking charge (`WHOLEFDS MKT #10452, -87.34` twice, 12 days apart) | **Kept in totals**, both flagged as a possible duplicate for human review. | No bank statement covers this file to arbitrate, and two grocery trips at the same store, same total, 12 days apart is plausible. Dropping either is a coin flip with no evidence — surfacing beats guessing. |
